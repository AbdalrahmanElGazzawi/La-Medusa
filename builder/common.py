...
def page(slug, lang, title, desc, body, jsonld="", og_title=None, extra_scripts="", noindex=False):
    is_ar = lang == "ar"
...
<header class="site-header">
  <div class="nav-wrap">
    ...
    <div style="display:flex;align-items:center;gap:10px">
      <a class="account-link" href="{prefix}/account/" aria-label="{account_aria}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><circle cx="12" cy="8" r="4"/><path d="M4 20c1.5-3.5 4.5-5 8-5s6.5 1.5 8 5"/></svg></a>
...
<script src="/assets/js/lm-backend.js" defer></script>
{extra_scripts}
</body>
</html>'''
